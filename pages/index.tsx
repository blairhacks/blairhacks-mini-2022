	...
	return (
		<>
			<Head>
				...
				<meta
					name="description"
					content="An IRL day of coding and making for high-schoolers in MoCo. Join us on December 10, 2022 10AM-6PM @ Rockville Memorial Library"
				/>
			</Head>
      ...
      /> */}
				...
				<div className="w-full h-full relative bg-black/75">
					<div className="p-8 h-full container max-w-5xl flex flex-col justify-center">
						<div className="flex flex-col sm:flex-row items-start sm:items-end gap-1 sm:gap-6">
							...
							<a
								href="https://poolesvillehacks.tech"
								target="_blank"
						...
						<ul className="flex flex-col sm:flex-row items-start gap-4 mt-6">
							<div className="flex gap-4">
								...
								<a
									href="https://g.page/mcplRockvilleMemorial"
									target="_blank"
									rel="noopener noreferrer"
								>
			...
			<main className="px-8 py-28 container max-w-5xl flex flex-col gap-20">
				...
				<section>
					...
					<p className="text-2xl font-thin mt-4">
						...
						2020)! BlairHacks Mini is a day-long event where high school
						students around Montgomery County will come together to build apps,
						games, and hardware. Look forward to a day of hands-on coding + tech
						workshops, fun activities, and more!
					</p>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-12 mt-16">
						<div className="order-1">
							...
							<h3 className="text-3xl font-bold mt-5">Build stuff!</h3>
							<p className="text-xl font-thin mt-2">
								Hardware, software, and you name it! You&#39;ll learn how to
								build something new and unique.
							</p>
						</div>
            ...
            /> */}
						...
						<div className="order-3 sm:order-4">
							...
							<h3 className="text-3xl font-bold mt-5">Make connections</h3>
							<p className="text-xl font-thin mt-2">
						...
						<div className="order-5">
							...
							<h3 className="text-3xl font-bold mt-5">Have fun</h3>
							<p className="text-xl font-thin mt-2">
								We have a day of fun activities and workshops planned. No
								competition, no stress, just fun!
							</p>
						</div>
            ...
            /> */}
				...
				<section>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
						<div className="p-4 border-2 border-emerald-400 rounded-xl">
							<h3 className="text-xl font-bold">Do you guys actually hack?</h3>
						...
						<div className="p-4 border-2 border-emerald-400 rounded-xl">
							...
							<p className="text-lg font-thin leading-6 mt-1.5">
								All high school students are welcome to attend. Bring your
								friends!
							</p>
						</div>

						<div className="p-4 border-2 border-emerald-400 rounded-xl">
							<h3 className="text-xl font-bold">What should I bring?</h3>
							<p className="text-lg font-thin leading-6 mt-1.5">
								Bring a laptop and a charger. Also, make sure to bring your own
								lunch, or money to buy food. There will be plenty of nearby
						...
						<div className="p-4 border-2 border-emerald-400 rounded-xl">
							...
							<p className="text-lg font-thin leading-6 mt-1.5">
								Yes! If you are a beginner, you can attend our workshops that we
								run throughout the event. They&#39;ll cover the basics of
								different tools you can use to build your hack.
							</p>
						</div>
						...
						<div className="p-4 border-2 border-emerald-400 rounded-xl">
							<h3 className="text-xl font-bold">I have another question!</h3>
							<p className="text-lg font-thin leading-6 mt-1.5">
								Send us an email at{" "}
								<a
									className="text-emerald-500 font-medium underline cursor-pointer"
				...
				<section>
					...
					<div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
						<a href="https://hackclub.com/hackathons/grant/" target="blank">
                ...
                /> */}
						...
						<a href="https://www.montgomerycountymd.gov/cupf/" target="blank">
							<div className="h-48 p-4 flex justify-center items-center rounded-xl bg-neutral-400/20 transition-all duration-300 border-2 border-emerald-400 border-opacity-0 hover:border-opacity-100">
								{/* <Image
                  src="/assets/cupf.png"
